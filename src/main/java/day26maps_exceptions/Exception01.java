...
public class Exception01 {
    public static void main(String[] args) {
        ...
        Tabi bu hatalari developer onceden ongorup handle etmeli, duzeltmelidir ama kullanici programimizi
   ...
   //     bolme(4, 0);//Hatanin sebebi sifir gonderilmesi
        bolme2(5, 0);
    }//main
    ...
    public static void bolme(int a, int b) {
        if (b == 0) {
            ...
            System.out.println(a / b);//Hata olusan satir
        }
    }
    ...
    public static void bolme2(int a, int b) {
        try {
            ...
            System.out.println("Lutfen sifira bolme islemi yapmayiniz");//Lutfen sifira bolme islemi yapmayiniz
        }
