...
public class Animal { //public final class Animal ==> Animal'in child'i olmaz
    ...
    */
    ...
    public void eat(){
        ...
        //pi = 3; pi'ye yeni deger atayamazsiniz
        System.out.println("Animals eat...");
    }

    //1-Override isleminde access modifier’larin durumlarini ogrendik.
    // Simdi de return type durumlarina bakalim.
    public Animal create(){ //Animal burada data type'dir
        //public final Animal create() override edilemez
