...
public class Sets01 {
    public static void main(String[] args) {
        ...
        System.out.println(hs2); //[Veli, Ali] new ile olustururken elemak ekleme kaldirma mumkun
                                                // ama Set.of ile baska eleman ekleyip silemezsin
        ...
        lhs.retainAll(ls); //degisiklige ugrayan method soldakidir
        ...
        System.out.println(ss1); //[G]  ==> elemanlar olmasada ikisi arasindakini seciyor
