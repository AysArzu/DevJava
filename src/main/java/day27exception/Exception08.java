...
/*
        ...
        */
        ...
        //read, dosya sonuna ulaşıldığında -1 değerini döndürür.

        //method signature a ekledik!!!
        FileInputStream fis = new FileInputStream("src/main/java/day27exception/file.txt");
        int k = 0;
