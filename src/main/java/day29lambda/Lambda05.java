...
public class Lambda05 {
    public static void main(String[] args) {
        ...
        tekrarsizCiftKareCarpimi(nums);
    }
        //1) Bir list'teki "Tekrarsiz" elemanlardan "çift" olanlarin "karesinin"
        // "çarpımını" hesaplayan bir method oluşturun
    public static void tekrarsizCiftKareCarpimi(List<Integer>nums){
      int result=  nums.stream().distinct().filter(t->t%2==0).map(t->t*t).reduce(1,(t,u)->t*u);
