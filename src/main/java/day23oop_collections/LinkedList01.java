...
public class LinkedList01 {
    public static void main(String[] args) {
       ...
       // Object <String> list5 = new ArrayList<>();HATA HERKESIN ATASI!!!
        Object list3 = new ArrayList<>();// BU SEKILDE OLUR!!
        ...
        constractor arasina yazdigimiz icin hata almayiz!
        ...
        List<String> immutableList = List.of("Eleman1","Eleman2","Eleman3"); //Boyut degistirilemez IMMUTABLE OLDU STRING GIBI
        immutableList.add("Serkan");
        System.out.println(immutableList); HATA*/ //BOYUTUNU DEGISTIREMEYIZ ONDAN HATA ALDIK
