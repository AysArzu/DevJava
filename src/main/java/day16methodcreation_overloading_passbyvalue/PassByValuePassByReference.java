package day16methodcreation_overloading_passbyvalue;

public class PassByValuePassByReference {
    public static void main(String[] args) {
   /*Pass by Value (Değer ile Geçiş):

        Bir değişkenin değerini, yani veriyi, bir methoda parametre olarak ilettiğinizde, aslında o değişkenin
